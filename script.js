...
if (pinsLayer && tip) {
  const pins = [
    ...
    { name: "South Korea", flag: "🇰🇷", color: "#1e88e5", x: 78, y: 29, url: "Korea/korea.html"},
    { name: "Japan",       flag: "🇯🇵", color: "#43a047", x: 91, y: 30, url: "Japan/japan.html" },
    { name: "Singapore",   flag: "🇸🇬", color: "#8e24aa", x: 44, y: 80, url: "Singapore/singapore.html" },
  ];
